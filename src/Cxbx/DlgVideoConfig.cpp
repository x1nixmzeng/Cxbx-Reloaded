...
/*! direct3d instance */
static Native::LPDIRECT3D8 g_pD3D8 = 0;
/*! video configuration */
...
VOID ShowVideoConfig(HWND hwnd)
{
    ...
    /*! initialize direct3d */
    {
        g_pD3D8 = Native::Direct3DCreate8(D3D_SDK_VERSION);
    ...
    switch(uMsg)
    {
        case WM_INITDIALOG:
        {
            ...
            /*! enumerate display adapters */
            {
                ...
                {
					Native::D3DADAPTER_IDENTIFIER8 adapterIdentifier;
...
VOID RefreshDisplayAdapter()
{
    ...
    {
        /*! device types */
        static const Native::D3DDEVTYPE devType[2] = { Native::D3DDEVTYPE_HAL, Native::D3DDEVTYPE_REF };
    ...
    /*! generate list of display modes */
    {
        ...
        /*! enumerate display modes */
        {
            ...
            for(uint32 v=0;v<dwAdapterModeCount;v++)
            {
				...
				Native::D3DDISPLAYMODE displayMode;
