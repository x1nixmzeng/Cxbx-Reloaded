...
XDK::HRESULT EmuRecompilePshDef( X_D3DPIXELSHADERDEF* pPSDef, Native::LPD3DXBUFFER* ppRecompiled );

/*
 * Kingofc's pixel shader functions
 */
// Pixel Shader Stuff
XDK::HRESULT CreatePixelShaderFunction(X_D3DPIXELSHADERDEF *pPSD, Native::LPD3DXBUFFER* ppRecompiled);

// PatrickvL's Dxbx pixel shader translation
XDK::HRESULT DxbxUpdateActivePixelShader(X_D3DPIXELSHADERDEF *pPSDef, XDK::DWORD *pHandle); // NOPATCH
