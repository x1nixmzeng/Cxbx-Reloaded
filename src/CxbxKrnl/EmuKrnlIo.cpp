...
XBSYSAPI EXPORTNUM(64) OBJECT_TYPE IoCompletionObjectType =
{
	...
	ExFreePool,
	NULL,
	NULL, // TODO : IopDeleteIoCompletion,
	NULL,
...
XBSYSAPI EXPORTNUM(71) OBJECT_TYPE IoFileObjectType =
{
	ExAllocatePoolWithTag,
	ExFreePool,
	NULL, // TODO : IopCloseFile,
	NULL, // TODO : IopDeleteFile,
	NULL, // TODO : IopParseFile,
...
)
{
	...
	CCHAR ret = 0; // ShareAccess->OpenCount;
