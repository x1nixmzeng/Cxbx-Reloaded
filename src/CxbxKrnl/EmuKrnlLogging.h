...
FLAGS2STR_HEADER(XDK::ALLOCATION_TYPE) // Not really an enum
ENUM2STR_HEADER(XDK::BUS_DATA_TYPE)
ENUM2STR_HEADER(XDK::CREATE_DISPOSITION) // Not really an enum
FLAGS2STR_HEADER(XDK::CREATE_OPTION) // Not really an enum
ENUM2STR_HEADER(XDK::EVENT_TYPE)
ENUM2STR_HEADER(XDK::EXCEPTION_DISPOSITION)
ENUM2STR_HEADER(XDK::FILE_INFORMATION_CLASS)
ENUM2STR_HEADER(XDK::FS_INFORMATION_CLASS)
ENUM2STR_HEADER(XDK::KINTERRUPT_MODE)
ENUM2STR_HEADER(XDK::KIRQL_TYPE) // Not really an enum
ENUM2STR_HEADER(XDK::KWAIT_REASON)
ENUM2STR_HEADER(XDK::KOBJECTS)
ENUM2STR_HEADER(XDK::MODE)
//ENUM2STR_HEADER(XDK::NTSTATUS) // Not really an enum
FLAGS2STR_HEADER(XDK::PROTECTION_TYPE) // Not really an enum
ENUM2STR_HEADER(XDK::RETURN_FIRMWARE)
ENUM2STR_HEADER(XDK::TIMER_TYPE)
ENUM2STR_HEADER(XDK::WAIT_TYPE)
ENUM2STR_HEADER(XDK::XC_VALUE_INDEX)

// Headers for rendering Xbox kernel types without pointer-to-type :
LOGRENDER_HEADER_BY_REF(XDK::BOOLEAN);
LOGRENDER_HEADER_BY_REF(XDK::PBYTE);
LOGRENDER_HEADER_BY_REF(XDK::PULONG);
...
LOGRENDER_HEADER(XDK::LARGE_INTEGER)
LOGRENDER_HEADER(XDK::LAUNCH_DATA_HEADER)
LOGRENDER_HEADER(XDK::LAUNCH_DATA_PAGE)
