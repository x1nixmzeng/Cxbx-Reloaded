...
extern "C" CXBXKRNL_API uint32 CxbxKrnl_KernelThunkTable[379] =
{
	...
	(uint32)FUNC(&xboxkrnl::MmDbgAllocateMemory),                 // 0x0176 (374) DEVKIT
	(uint32)FUNC(&xboxkrnl::MmDbgFreeMemory),                     // 0x0177 (375) DEVKIT
	(uint32)FUNC(&xboxkrnl::MmDbgQueryAvailablePages),            // 0x0178 (376) DEVKIT
	(uint32)FUNC(&xboxkrnl::MmDbgReleaseAddress),                 // 0x0179 (377) DEVKIT
	(uint32)FUNC(&xboxkrnl::MmDbgWriteCheck),                     // 0x017A (378) DEVKIT
};
