...
ENUM2STR_HEADER(Native::D3DCUBEMAP_FACES)
ENUM2STR_HEADER(Native::D3DFORMAT)
ENUM2STR_HEADER(Native::D3DPOOL)

//
// Host D3D LOGRENDER_HEADER(Type) declarations
//

LOGRENDER_HEADER(Native::D3DLOCKED_RECT)
LOGRENDER_HEADER(Native::RECT);
...
LOGRENDER_HEADER(Native::D3DVIEWPORT8)
